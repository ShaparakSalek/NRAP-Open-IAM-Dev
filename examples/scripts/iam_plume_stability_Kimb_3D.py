"""
Example illustrates plume stability analysis functionality using a 3D data file.
3D data is reduced to 2D by taking the max value in the third dimension
for each time point.
...
Example of run:
$ python iam_plume_stability_Kimb_3D.py
"""
...
if __name__ == '__main__':
    ...
    M = read_Mesh2D_data(os.path.join(datafolder, 'Reservoir_data_sim01_3D.h5'),
                         ['pressure', 'CO2saturation'], time_points, True)
    ...
    # Create overpressure variable by subtracting each pressure dataset
    # from the first pressure dataset
    ...
    # Now you can utilize the methods of the class to facilitate plotting
    # plume stability metrics
    # Plot plume areas
    f, ax = plt.subplots(1)
