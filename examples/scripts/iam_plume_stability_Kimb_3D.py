...
using a 3D data file. 3D data is reduced to 2D by taking
the max value in the third dimension for each time point.
...
M = read_Mesh2D_data(os.path.join(datafolder, 'Reservoir_data_sim01_3D.csv'),
                     os.path.join(datafolder, 'time_points.csv'))
