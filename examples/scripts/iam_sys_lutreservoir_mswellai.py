...
if __name__ == '__main__':
    ...
    plt.plot(time_array/365.25, pressure/1.0e+6, color="maroon", linewidth=2)
    plt.xlabel('Time (years)', fontsize=14, fontweight='bold')
    plt.ylabel('Pressure (MPa)', fontsize=14, fontweight='bold')
    ...
    plt.plot(time_array/365.25, saturation, color="green", linewidth=2)
    plt.xlabel('Time (years)', fontsize=14, fontweight='bold')
    ...
    plt.plot(time_array/365.25, CO2_aquifer1, color="green", linewidth=2)
    plt.xlabel('Time (years)', fontsize=14, fontweight='bold')
