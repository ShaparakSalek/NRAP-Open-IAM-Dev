...
CFI_EXAMPLES = {
    ...
    '31a': 'Simple reservoir, Open wellbore, FutureGen2 aquifer, AoR setup, forward',
    '31b': 'Simple reservoir, Open wellbore, Generic aquifer, AoR setup, forward',
    '31c': 'Simple reservoir, Open wellbore, FutureGen2 aquifer, AoR setup, LHS',
    '31d': 'Simple reservoir, Open wellbore, FutureGen2 aquifer, AoR setup, TimeList option, LHS',
    '31e': 'Simple reservoir, Cemented wellbore, FutureGen2 aquifer, AoR setup, forward',
    '31f': 'Simple reservoir, Multisegmented wellbore, FutureGen2 aquifer, AoR setup, forward',
    ...
    '56b': ''.join(['Simple reservoir, Open wellbore, FutureGen2 aquifer, ',
                    'Workflow: AoR, AoR plots, forward']),
    '56c': ''.join(['Simple reservoir, Open wellbore, FutureGen2 aquifer, ',
                    'Workflow: AoR, forward']),
    '56d': ''.join(['Simple reservoir, Open wellbore, FutureGen2 aquifer, ',
                    'Workflow: AoR, LHS']),
    '56e': ''.join(['Simple reservoir, Multisegmented wellbore, FutureGen2 aquifer, ',
                    'Workflow: AoR, forward']),
    '56f': ''.join(['Simple reservoir, Multisegmented wellbore, FutureGen2 aquifer, ',
                    'Workflow: AoR, forward']),
    '56g': ''.join(['Simple reservoir, Cemented wellbore, FutureGen2 aquifer, ',
                    'Workflow: AoR, forward']),
    ...
    '57c': ''.join(['Simple reservoir, Open wellbore, Generic aquifer, ',
                    'Workflow: TTFD, forward']),
