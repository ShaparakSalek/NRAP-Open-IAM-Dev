...
CFI_EXAMPLES = {
    ...
    '4b': ''.join(['Analytical reservoir, Open wellbore (multiple locations), ',
                   'critical pressure, forward']),
    ...
    '8a': ''.join(['Analytical reservoir, Multisegmented wellbore, LHS, ',
                   'sensitivity analysis plot options']),
    '8b': ''.join(['Analytical reservoir, Multisegmented wellbore, LHS, ',
                   'sensitivity analysis plot options']),
    '8c': ''.join(['Analytical reservoir, Open wellbore, FutureGen2 aquifer, ',
                   'LHS, sensitivity analysis plot options']),
    ...
    '31d': ''.join(['Analytical reservoir, Open wellbore, FutureGen2 aquifer, ',
                    'AoR setup, TimeList option, LHS']),
    '31e': ''.join(['Analytical reservoir, Cemented wellbore, FutureGen2 aquifer, ',
                    'AoR setup, forward']),
    '31f': ''.join(['Analytical reservoir, Multisegmented wellbore, ',
                    'FutureGen2 aquifer, AoR setup, forward']),
    ...
    '58d': ''.join(['Analytical reservoir, Open wellbore (multiple deterministic ',
                    'and random locations), Workflow: LeakageAssessment, forward']),
    '59a': 'Analytical reservoir, Open wellbore, FutureGen2 aquifer, bowtie plot, LHS',
    '59b': ''.join(['Analytical reservoir, Open wellbore, FutureGen2 aquifer, ',
                    'bowtie plot (time list option), LHS']),
    '59c': ''.join(['Analytical reservoir, Open wellbore, FutureGen2 aquifer, ',
                    'bowtie plot (pre-made csv files), LHS']),
    '60a': ''.join(['LUT reservoir, Multisegmented wellbore (multiple locations), ',
                    'FutureGen2 aquifer, bowtie plot, LHS']),
    '60b': ''.join(['No components specified, bowtie plot (pre-made csv files), LHS']),
    '60c': ''.join(['LUT reservoir, Multisegmented wellbore (multiple locations), ',
                    'FutureGen2 aquifer, bowtie plot, LHS']),
    }
