...
from openiam.gu_interface.dictionarydata import GFR_PARAMETER_LABEL_WIDTH

from openiam.gu_interface.cmpnts_tabs.locations import read_locations_data, add_wellbore_frame_widgets
